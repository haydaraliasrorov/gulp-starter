...
const iconsfont = () => {
  return gulp
    .src([
      ...
      "./node_modules/bootstrap-icons/font/fonts/*.{woff,woff2,ttf}",
    ])
...
// Devalop command
const develop = gulp.series(build, gulp.parallel(watching, server));

// Default command
export default option.isP ? build : develop;
